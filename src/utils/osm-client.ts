        ...
        osm: {
            changeset: {
                ...
                tag: [
                    ...
                    {
                        $k: 'imagery_used',
                        $v: 'Geoportal Berlin / Digitale farbige Orthophotos 2021, 2020, 2019; Straßenbefahrung 2014; ALKIS Berlin',
                    },
                    { $k: 'comment', $v: 'Parking lanes; https://wiki.openstreetmap.org/wiki/Berlin/Verkehrswende/Parkraum/Editor' },
                ],
            },
        },
    }
