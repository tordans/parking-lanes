import { getLaneSchemeConditions, parseConditionsBySchemeV1, parseConditionsBySchemeV2, parseDefaultCondition } from '../parking/domain/lane-scheme-conditions'
...
describe('lane-scheme conditions', () => {
    test('scheme v2 conditional with default tag', () => {
        ...
        expect(conditions.conditionalValues![0].condition).toBeNull()
    })
