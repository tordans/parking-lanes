...
| StreetComplete CyclewayParser | [../projects/streetcomplete-cycleway-parser.md](../projects/streetcomplete-cycleway-parser.md) | 215+ `@Test` functions | `cycleway:*` combinations; read-only parser |
