...
| StreetComplete CyclewayParser | @westnordost | Cycleway Q&A; exhaustive tests | [CyclewayParser.kt](https://github.com/streetcomplete/StreetComplete/blob/master/app/src/commonMain/kotlin/de/westnordost/streetcomplete/osm/cycleway/CyclewayParser.kt) | Yes — [_streetcomplete-cycleway-parser.md](../projects/_streetcomplete-cycleway-parser.md) | — |
| shared-row Slice spec | @d-wasserman | Target lane-type vocabulary | [Slice.md](https://github.com/d-wasserman/shared-row/blob/main/specification/MarkdownTables/Slice.md) | Yes — [_shared-row.md](../projects/_shared-row.md) | — |
| Berlin Radwege examples | @tordans | Micromapping tagging patterns | [wiki](https://wiki.openstreetmap.org/wiki/Berlin/Verkehrswende/Radwege#Tagging-Beispiele) | Partial — [berlin-verkehrswende-radwege.md](../projects/berlin-verkehrswende-radwege.md) | [README § Optional deeper research](../README.md#optional-deeper-research) |
...
| Streetmix | @tordans, @dabreegster | UX target; OSM tag recommendations | https://streetmix.net/ | Yes — [_streetmix.md](../projects/_streetmix.md) | [README § Optional deeper research](../README.md#optional-deeper-research) |
...
| CycleStreets / area:highway | @mvl22 | Junction-area routing (SOTM 2019) | [talk](https://www.cyclestreets.org/news/2019/09/22/sotm2019/) | Partial — [_cyclestreets-areahighway.md](../projects/_cyclestreets-areahighway.md) | [README § Optional deeper research](../README.md#optional-deeper-research) |
| twpol/osm-tiles | @twpol | Lane overlay map; wants shared test suite | https://github.com/twpol/osm-tiles | Yes — [_twpol-osm-tiles.md](../projects/_twpol-osm-tiles.md) | — |
...
| 3DStreet | @kfarr | 3D street viz; pinged stakeholder | https://github.com/3DStreet/3dstreet | Partial — [_3dstreet.md](../projects/_3dstreet.md) | [README § Optional deeper research](../README.md#optional-deeper-research) |
| AB Street osm_viewer | @dabreegster | Web import + lane visualization goal | [osm_viewer](https://a-b-street.github.io/docs/software/osm_viewer.html) | Partial — [abstreet-osm-viewer.md](../projects/abstreet-osm-viewer.md), osm2streets | [README § Optional deeper research](../README.md#optional-deeper-research) |
| AB Street road editor | @dabreegster | Limited lane edit UI retrospective | [retrospective](https://a-b-street.github.io/docs/project/retrospective/index.html#road-editor) | Partial — [abstreet-osm-viewer.md](../projects/abstreet-osm-viewer.md), osm2streets lane editor | — |
