...
**Implemented:** layout + SVG live in [`packages/osm-lane-diagram`](../../packages/osm-lane-diagram/) (`@osm-editor-kit/osm-lane-diagram`); browse fixtures at the app’s [`/audit-lanes`](../../app/src/routes/audit-lanes.tsx) gallery.
